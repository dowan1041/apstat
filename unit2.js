...
registerUnit({
  ...
  chapterIds: ['2-1', '2-2', '2-3', '2-4', '2-5', '2-6', '2-7', '2-8', '2-9', '2-10', '2-11', '2-12']
});
  ...
  '2-1': {
    ...
    sections: [
      ...
      /* ---------------- 8. QUIZ ---------------- */
      {
        ...
        questions: [
          ...
          { q: 'Of 75 males, 8% like chocolate. Of 125 females, 43.2% like chocolate. This is evidence of:', opts: ['Independence', 'Nothing — the sample sizes are too different to compare', 'An association between gender and liking chocolate', 'A calculation error'], correct: 2, exp: 'The proportion who like chocolate changes a lot depending on gender (8% vs. 43.2%), which is exactly what an association looks like.' },
          { q: '26% of males and 26% of females like Skittles. This means gender and liking Skittles are:', opts: ['Independent (no association)', 'Associated', 'Impossible to compare', 'Both associated and independent'], correct: 0, exp: 'Equal proportions across groups means the condition (gender) doesn’t change the outcome — that’s the definition of independence.' },
          { q: 'Elementary school: 60% of 100 bottles sold were small (60 bottles). Middle school: 33.3% of 300 bottles sold were small (100 bottles). Which statement is correct?', opts: ['Elementary sold more small bottles because its proportion is higher', 'Proportion and total count always agree', 'Both schools sold the same number of small bottles', 'Middle school sold more small bottles in total, even though its proportion is lower'], correct: 3, exp: 'A higher proportion doesn’t mean a higher total — middle school’s much larger total sales (300 vs. 100) means its smaller proportion still adds up to more actual small bottles (100 vs. 60).' }
        ]
      },
    ...
    homework: {
      ...
      questions: [
        ...
        { q: 'A two-way table of 250 people crosses "owns a pet" (yes/no) with "lives in an apartment" (yes/no). Which of the following is a valid way to fill the interior cells?', opts: ['Frequencies or relative frequencies', 'Only percentages', 'Only decimals between 0 and 1', 'Names of individual people'], correct: 0, exp: 'Two-way table cells can hold either frequencies (counts) or relative frequencies (proportions) — both are standard.' },
        { q: 'A researcher wants to compare the raw number of students who prefer math vs. science, separately for 9th and 10th graders. Which graph type is the most natural first choice?', opts: ['Pie chart', 'Mosaic plot', 'Side-by-side bar graph', 'Segmented bar graph'], correct: 2, exp: 'Side-by-side bar graphs display raw counts directly, which is exactly what’s needed to compare head counts between groups.' },
        { q: 'In a segmented bar graph comparing two groups of very different sizes (50 people vs. 500 people), why is it still a fair comparison?', opts: ['Every bar is scaled to 100%, so you’re comparing proportions, not raw counts', 'The smaller group is automatically excluded', 'Segmented bars only work when group sizes are equal', 'It isn’t fair — segmented bars can never be trusted'], correct: 0, exp: 'Because every bar is stretched to represent 100% regardless of its actual size, segmented bar graphs let you compare proportions fairly even when the underlying group sizes differ a lot.' },
        ...
        { q: 'Of 60 dog owners, 45 said they exercise daily. Of 40 non-dog-owners, 12 said they exercise daily. What is the best next step to check for association?', opts: ['Compare the proportions: 45/60 vs. 12/40', 'Add 45 and 12 together', 'Compare 45 to 12 directly', 'Nothing can be determined from this data'], correct: 0, exp: 'Because the two groups have different sizes (60 vs. 40), you must compare proportions (75% vs. 30%), not raw counts, to fairly judge association.' },
        { q: 'Using the previous question’s data (75% of dog owners exercise daily vs. 30% of non-owners), is there an association between dog ownership and daily exercise?', opts: ['Cannot be determined without a pie chart', 'No, because both groups have some people who exercise daily', 'Yes, because the proportion changes a lot depending on dog ownership', 'No, because 45 is greater than 12'], correct: 2, exp: 'A large shift in proportion (75% vs. 30%) when you change the condition (dog ownership) is the definition of an association.' },
        { q: 'A survey finds that 40% of coffee drinkers and 40% of non-coffee-drinkers report trouble sleeping. What can you conclude?', opts: ['There is an association between coffee drinking and trouble sleeping', 'The sample size must be reported before any conclusion is possible', 'Coffee drinking causes trouble sleeping', 'Coffee drinking and trouble sleeping appear to be independent in this sample'], correct: 3, exp: 'Equal proportions (40% and 40%) across both groups means the condition doesn’t change the outcome — that’s the signature of independence, not association.' },
        { q: 'Store A sold 200 items, 25% of which were on clearance (50 items). Store B sold 800 items, 15% of which were on clearance (120 items). Which statement is true?', opts: ['Both stores sold the same number of clearance items', 'Store A sold more clearance items than Store B', 'Proportion and raw count must always match', 'Store B sold more clearance items than Store A, even though its clearance proportion is lower'], correct: 3, exp: 'Store B’s much larger total (800 vs. 200) means its lower percentage still produces a bigger raw count: 120 clearance items vs. Store A’s 50.' },
        { q: 'Why can a mosaic plot correct a mistake that a same-width segmented bar graph might lead you to make?', opts: ['It cannot — the two graphs always give the same information', 'It adds bar width proportional to group size, showing when a higher proportion still doesn’t mean a higher total count', 'It removes the need for proportions entirely', 'It only displays quantitative data'], correct: 1, exp: 'A same-width segmented bar graph shows proportions only, which can trick you into thinking a bigger percentage always means a bigger total. A mosaic plot’s width exposes the actual group sizes.' },
        { q: 'A two-way table has a grand total of 400. A specific cell has a count of 60. What is the relative frequency of that cell?', opts: ['6.0%', '15%', '150%', '60%'], correct: 1, exp: '60/400 = 0.15 = 15%. Relative frequency is always the cell count divided by the total being referenced.' },
        { q: 'A two-way table crosses "favorite season" (4 categories) with "grade level" (3 categories). How many interior cells does the table have (not counting margin totals)?', opts: ['7', '12', '3', '4'], correct: 1, exp: 'A two-way table has (number of row categories) × (number of column categories) interior cells — here, 4 × 3 = 12.' },
        ...
        { q: 'A study of 500 people crosses "exercise regularly" (yes/no) with "drinks soda daily" (yes/no). If exercise and soda-drinking are independent, what would you expect to see in a segmented bar graph?', opts: ['Two bars with very different proportions of soda drinkers', 'Two bars with the same proportion of soda drinkers', 'Only one bar, since independent variables merge into one category', 'A pie chart instead of a bar graph'], correct: 1, exp: 'Independence means the proportion doesn’t change based on the condition — so both the "exercise" and "no exercise" bars would show the same percentage of soda drinkers.' },
        { q: 'Which of the following would make a mosaic plot most useful, compared to a plain segmented bar graph?', opts: ['When there is only one categorical variable', 'When both groups being compared have exactly the same total size', 'When the groups being compared have very different total sizes', 'When you only care about raw counts and not proportions at all'], correct: 2, exp: 'A mosaic plot’s extra width information matters most when group sizes differ a lot — otherwise, equal-width segmented bars already tell the full story.' },
        { q: 'A two-way table shows 30 out of 90 juniors and 45 out of 90 seniors play a sport. Is there an association between grade level and playing a sport?', opts: ['No, because both groups have 90 people', 'Yes, because 30/90 (33.3%) and 45/90 (50%) are different proportions', 'No, because 45 is only 15 more than 30', 'Cannot be determined without a graph'], correct: 1, exp: 'With equal group sizes, comparing proportions (33.3% vs. 50%) directly shows the outcome shifts with grade level — an association.' },
        { q: 'A mosaic plot shows Store X’s bar is much narrower than Store Y’s bar, but within Store X’s bar, the "returned item" segment is proportionally much larger. What can you conclude?', opts: ['Store X definitely had more total returns than Store Y', 'Narrow bars always mean fewer returns', 'Store X had a higher return *rate*, but you’d need the actual widths (totals) to know which store had more total returns', 'The mosaic plot cannot show this information'], correct: 2, exp: 'A larger segment shows a higher proportion (rate), but because Store X’s bar is narrower (smaller total sales), you cannot assume it has more total returns without comparing the actual counts.' },
        ...
        { q: 'A survey of 120 cat owners and 80 dog owners asks whether the pet sleeps indoors. 108 of the cat owners say yes; 76 of the dog owners say yes. What are the two conditional proportions to compare?', opts: ['108 and 76 directly, no division needed', '108/200 and 76/200', '108/80 and 76/120', '108/120 and 76/80'], correct: 3, exp: 'To compare fairly across groups of different sizes, divide each "yes" count by its own group total: cat owners 108/120, dog owners 76/80.' },
        { q: 'Which of these correctly restates the definition of "association" between two categorical variables?', opts: ['The proportion of one variable’s outcome changes depending on the level of the other variable', 'The two-way table has more rows than columns', 'The two variables must both be quantitative', 'The two variables always have equal sample sizes'], correct: 0, exp: 'Association means the outcome proportion for one variable shifts depending on which category of the other variable you condition on.' },
  ...
  '2-2': {
    ...
    sections: [
      ...
      /* ---------------- 7. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'A statistic is best defined as:', opts: ['A number that must come from a two-way table', 'Only the mean of a data set', 'Any number describing an entire population', 'Any numerical piece of information that comes from a sample'], correct: 3, exp: 'A statistic is any number that comes from a sample — including every marginal, joint, and conditional proportion pulled from a two-way table.' },
          { q: 'A marginal relative frequency is calculated as:', opts: ['Two cells added together', 'A cell divided by its row total', 'A row or column total divided by the grand total', 'A cell divided by the grand total'], correct: 2, exp: 'Marginal relative frequency comes from the margins — a row or column total over the grand total for the whole table.' },
          ...
          { q: 'In the notation P(A | B), what does the vertical bar mean?', opts: ['Multiplication', '"Given" — B is the restriction/condition', '"And"', '"Not"'], correct: 1, exp: 'The bar means "given." Whatever comes after it is the condition that restricts your denominator.' },
          { q: 'Of 188 students, 35 rode the bus and 9 of those were tardy. What is P(Tardy | Bus)?', opts: ['35/188', '9/64', '9/188', '9/35'], correct: 3, exp: 'Conditioning on "rode the bus" restricts the denominator to the 35 bus riders, not the full 188: 9/35 ≈ 25.7%.' },
          { q: 'Using the same data, what is P(Bus ∩ Tardy)?', opts: ['9/188', '64/188', '35/188', '9/35'], correct: 0, exp: 'Joint relative frequency always divides by the grand total: 9/188 ≈ 4.8%.' },
          { q: 'Overall, 34% of students are tardy. Of bus riders, 25.7% are tardy. Of self-drivers, 45.6% are tardy. What does this show?', opts: ['An association between transportation and tardiness', 'No association — the numbers are all similar', 'A calculation error, since they should all equal 34%', 'That bus riders and self-drivers are the same group'], correct: 0, exp: 'The proportion shifts noticeably depending on the condition (transportation mode), which is the definition of an association.' },
          { q: 'If transportation had zero effect on tardiness, about how many of the 90 self-drivers should be tardy, given an overall tardy rate of 34%?', opts: ['34', '90', '≈31', '64'], correct: 2, exp: 'Expected count under no association = row total × overall marginal rate = 90 × 0.34 ≈ 30.6 ≈ 31.' }
        ]
      },
    ...
    homework: {
      ...
      questions: [
        ...
        { q: 'A marginal relative frequency comes from dividing:', opts: ['A cell by its row total', 'Two row totals by each other', 'A row or column total by the grand total', 'A cell by the grand total'], correct: 2, exp: 'Marginal relative frequency uses only the margins: a row total or column total, divided by the grand total.' },
        ...
        { q: 'In the same table, 180 people total own a car. What is P(owns a car)?', opts: ['180/300', '90/300', '180/90', '300/180'], correct: 0, exp: 'This is a marginal question — one variable, one margin total (180) divided by the grand total (300).' },
        { q: 'Of the 180 car owners, 90 live in the city. What is P(lives in the city | owns a car)?', opts: ['90/300', '180/300', '90/180', '180/90'], correct: 2, exp: 'Conditioning on "owns a car" restricts the denominator to the 180 car owners, not the full 300: 90/180.' },
        { q: 'Which of these is the correct notation for "the proportion of students who play soccer AND are freshmen"?', opts: ['P(Soccer ∩ Freshman)', 'P(Freshman | Soccer)', 'P(Soccer | Freshman)', 'P(Soccer) + P(Freshman)'], correct: 0, exp: '"And" signals a joint probability, notated with the intersection symbol ∩ (or the word "and").' },
        { q: 'Which of these is the correct notation for "of the students who play soccer, the proportion who are freshmen"?', opts: ['P(Freshman | Soccer)', 'P(Soccer)', 'P(Freshman ∩ Soccer)', 'P(Soccer | Freshman)'], correct: 0, exp: 'The restriction ("of the students who play soccer") goes after the bar. You want the freshman proportion, so freshman comes first: P(Freshman | Soccer).' },
        { q: 'A restriction/condition in a conditional relative frequency question can appear:', opts: ['Only at the beginning of the sentence', 'Anywhere in the sentence — but always after the bar in notation', 'Only if the word "given" is used', 'Only at the end of the sentence'], correct: 1, exp: 'The condition can be phrased anywhere in the English sentence, but when written in P(A | B) notation, it always goes after the bar.' },
        { q: 'A survey of 400 people finds P(likes jazz) = 25%. Among the 150 people over age 50, 60 like jazz. What does this tell you?', opts: ['The two variables must be independent since both numbers involve jazz', 'P(likes jazz | over 50) = 60/150 = 40%, which is higher than the marginal 25% — evidence of association', 'Nothing can be concluded without a bar graph', 'P(likes jazz | over 50) = 60/400, no different from marginal'], correct: 1, exp: 'Conditioning on "over 50" gives 60/150 = 40%, clearly higher than the overall 25% marginal rate — the shift signals an association between age and liking jazz.' },
        { q: 'If age and liking jazz were truly independent (no association) in a sample of 150 people over 50, with an overall jazz-liking rate of 25%, about how many of them would be expected to like jazz?', opts: ['≈37 or 38', '150', '25', '60'], correct: 0, exp: 'Expected count under no association = row total × marginal rate = 150 × 0.25 = 37.5 ≈ 38.' },
        ...
        { q: 'A two-way table crosses "brand loyalty" (yes/no) with "age group" (young/old), with a grand total of 500. Which computation gives a marginal relative frequency?', opts: ['(loyal) / (old total)', '(loyal) / (young total)', '(young AND loyal) / 500', '(young total) / 500'], correct: 3, exp: 'A marginal relative frequency only involves one variable — a single row or column total divided by the grand total, like (young total) / 500.' },
        { q: 'Which computation from the same table gives a conditional relative frequency?', opts: ['(loyal total) / 500', '(young AND loyal) / (young total)', '(old total) / 500', '(young AND loyal) / 500'], correct: 1, exp: 'Dividing the joint cell by just one margin total (not the grand total) restricts the group — that’s conditional: (young AND loyal) / (young total).' },
        { q: 'A two-way table shows P(A) = 40% overall. When conditioned on B, P(A | B) = 41%. What is the most reasonable conclusion?', opts: ['A strong association between A and B', 'Little to no meaningful association — the proportions are very close', 'B causes A', 'The table must contain an error'], correct: 1, exp: 'A tiny shift (40% to 41%) suggests the condition barely changes the outcome — that looks like independence, not a meaningful association.' },
        { q: 'A restaurant survey of 250 diners crosses "ordered dessert" with "dined on a weekend." 150 dined on a weekend, and of those, 90 ordered dessert. What is P(dessert | weekend)?', opts: ['90/250', '150/90', '90/150', '150/250'], correct: 2, exp: 'Conditioning on "weekend" restricts the denominator to the 150 weekend diners: 90/150 = 60%.' },
        { q: 'In that same survey, 60 total diners ordered dessert (weekday + weekend combined). What is P(dessert)?', opts: ['150/250', '60/150', '60/250', '90/250'], correct: 2, exp: 'This is a marginal question (one variable, dessert), so it uses the grand total: 60/250.' },
        { q: 'Comparing P(dessert) = 24% overall to P(dessert | weekend) = 60%, what should you conclude?', opts: ['No association — the numbers are unrelated', 'This can only be a joint relative frequency question', 'The sample size is too small to say anything', 'There is an association between dining on a weekend and ordering dessert'], correct: 3, exp: 'A large shift from the marginal (24%) to the conditional (60%) is exactly what an association looks like.' },
        { q: 'A two-way table has a grand total of 600. Row "Group X" totals 200. Within Group X, 50 people said yes to some question. What is P(yes ∩ Group X)?', opts: ['50/50', '50/200', '200/600', '50/600'], correct: 3, exp: 'Joint relative frequency divides the cell (50) by the grand total (600), not the row total.' },
        { q: 'Using the same table, what is P(yes | Group X)?', opts: ['50/600', '200/600', '600/200', '50/200'], correct: 3, exp: 'Conditioning on Group X restricts the denominator to that row’s total: 50/200.' },
        { q: 'Why is comparing a marginal proportion to a conditional proportion the standard way to check for association?', opts: ['Because the marginal proportion shows the "no information" baseline, and a conditional proportion shows what happens once you know one variable — a big gap between them means that variable matters', 'Because joint probabilities cannot be compared to anything', 'Because they are always numerically identical', 'Because AP Statistics requires starting every answer with the word "marginal"'], correct: 0, exp: 'The marginal proportion is your baseline expectation with no extra information. If knowing one variable (the condition) shifts that baseline a lot, the variables are associated — that comparison is the whole logic of this topic.' }
      ]
    }
  }
});
  ...
  '2-3': {
    ...
    sections: [
      ...
      /* ---------------- 7. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'A random process is best described as:', opts: ['A process that always produces the same outcome', 'A process with only one possible result', 'A process whose result is determined by chance, with known possible outcomes', 'Any process involving a computer'], correct: 2, exp: 'A random process has known possible outcomes, but which one occurs on a given trial is determined by chance.' },
          { q: 'Rolling a single die and getting a 4 is an example of a(n):', opts: ['Simulation', 'Outcome', 'Event', 'Law of large numbers'], correct: 1, exp: 'One specific result of one trial (rolling a 4) is an outcome. "Rolling an even number" would be an event — a collection of outcomes.' },
          { q: 'Probability is formally defined as:', opts: ['Always exactly 50%', 'The result of a single trial', 'A number that can exceed 1', 'The long-run relative frequency of an outcome or event'], correct: 3, exp: 'Probability is the proportion of times an outcome or event occurs, but only over a very large number of trials — its long-run relative frequency.' },
          ...
          { q: 'When simulating 5 independent coin tosses, should repeated numbers be allowed in the random number generator?', opts: ['Yes, because each toss is independent — one toss doesn’t affect the next', 'It doesn’t matter either way', 'Only if the coin is unfair', 'No, because each toss must be different'], correct: 0, exp: 'Coin tosses are independent, so repeats must be allowed — getting "heads" on one toss has zero effect on the next.' },
          { q: 'When simulating the random selection of 8 different stores out of 800 (no store can be picked twice), should repeats be allowed?', opts: ['No — once a store is selected, it can’t be selected again', 'Yes, always allow repeats in simulations', 'Only for the first 4 selections', 'Repeats don’t matter since all stores are identical'], correct: 0, exp: 'Selecting without replacement (you can’t pick the same store twice) means repeats must NOT be allowed in the simulation.' },
          ...
          { q: 'Which of these is NOT one of the five steps in designing a simulation?', opts: ['Run many trials and use the proportion of successes to estimate the probability', 'State what numbers will be used and what they represent', 'Explain how the random number generator will be used (repeats, how many numbers)', 'Calculate the exact theoretical probability using a formula before simulating'], correct: 3, exp: 'A simulation is specifically used when you want to estimate a probability without a formula. The five steps are: assign numbers, describe the random number generator, state what to count, define success, and run many trials.' }
        ]
      },
    ...
    homework: {
      estTime: '~30 min',
      questions: [
        { q: 'A random process is best defined as:', opts: ['A process with a single guaranteed outcome', 'A process that can never be repeated', 'Any process that uses a computer program', 'A process that generates results determined by chance, with the possible outcomes known in advance'], correct: 3, exp: 'A random process has known possible outcomes, but the specific result of any one trial is determined by chance.' },
        { q: 'Drawing one card from a shuffled deck and getting the Queen of Hearts is an example of a(n):', opts: ['Event', 'Simulation', 'Outcome', 'Law of large numbers'], correct: 2, exp: 'A single specific result of one trial is an outcome. "Drawing a face card" would be an event instead.' },
        { q: '"Rolling an odd number" on a fair six-sided die is an example of a(n):', opts: ['Outcome', 'Event', 'Probability', 'Trial'], correct: 1, exp: 'This is a collection of outcomes (1, 3, and 5), which makes it an event, not a single outcome.' },
        ...
        { q: 'A weighted spinner lands on blue 15% of the time. To simulate one spin using numbers 00–99, which range should represent "blue"?', opts: ['00–15', '85–99', '00–99', '00–14'], correct: 3, exp: 'You need exactly 15 numbers out of 100 to represent a 15% chance: 00–14 is 15 numbers (00,01,...,14).' },
        { q: 'A survey shows 40% of customers return a product within 30 days. Using numbers 1–100 to simulate one customer, which range should represent "returns the product"?', opts: ['1–100', '1–39', '60–100', '1–40'], correct: 3, exp: '40% of 100 numbers is 40 numbers: 1–40 represents exactly a 40% chance.' },
        ...
        { q: 'When simulating a raffle where 5 unique winners are drawn from 200 tickets (no ticket can win twice), should repeats be allowed?', opts: ['It does not matter for raffles', 'Yes, always', 'Only if there are more than 100 tickets', 'No — once a ticket is drawn, it can’t be drawn again'], correct: 3, exp: 'Selecting distinct winners without replacement means repeats must not be allowed in the simulation.' },
        { q: 'A simulation of a 50%-probability event run for only 6 trials produces 1 success (about 17%). What is the best explanation?', opts: ['The true probability must be 17%', 'Six trials is always enough to find the true probability', 'With so few trials, a result far from 50% happens easily just by chance — more trials are needed', 'The simulation is defective'], correct: 2, exp: 'Small trial counts are highly variable due to chance. The law of large numbers says you need far more trials before the estimate reliably approaches the true probability.' },
        { q: 'What is the correct order of the five simulation design steps?', opts: ['Define success → run one trial → done', 'Assign numbers and what they represent → describe the random number generator (repeats, quantity) → state what to count → define a successful trial → run many trials', 'Run trials, then assign numbers, then define success', 'Calculate the exact probability with a formula, then simulate to double-check'], correct: 1, exp: 'The five steps, in order: assign numbers and their meaning, describe how the random number generator will be used, state what you’re counting, define a successful trial, then run many trials.' },
        { q: 'A city bus is on time 80% of the time. To simulate 4 independent bus arrivals using numbers 00–99, which setup is correct?', opts: ['00–79 = on time (80 numbers), 80–99 = late (20 numbers); pick 4 numbers, repeats allowed', '00–80 = on time, 81–99 = late; pick 4 numbers, no repeats', '00–19 = on time, 20–99 = late; pick 4 numbers, repeats allowed', '00–79 = on time, 80–99 = late; pick 4 numbers, no repeats'], correct: 0, exp: '80% needs 80 numbers (00–79). Since bus arrivals are independent events, repeats should be allowed, not forbidden.' },
        { q: 'A teacher wants to estimate the probability that at least 2 of 4 randomly selected (with replacement) students in a class of 30 prefer online homework, given 25% of all students do. What range of numbers correctly represents "prefers online homework" out of 00–99?', opts: ['25–99 (75 numbers)', '00–25 (26 numbers)', '00–24 (25 numbers)', '00–29 (30 numbers, matching class size)'], correct: 2, exp: 'A 25% probability needs 25 numbers out of 100: 00–24 is exactly 25 numbers. The class size (30) is irrelevant to the number assignment here.' },
        { q: 'In a simulation of 10 free throws for a 65% shooter, what should be counted as a "trial"?', opts: ['All 10 simulated shots together, checked against the success condition', 'Only the shots that were makes', 'The random number generator itself', 'A single one of the 10 shots'], correct: 0, exp: 'A trial is one full repetition of the entire event — here, one full set of 10 simulated shots, evaluated against the success condition.' },
        { q: 'After running a simulation for 5,000 trials, the estimated probability is 43.9%, very close to the calculated true probability of 43.78%. What does this closeness demonstrate?', opts: ['Coincidence with no statistical explanation', 'The law of large numbers — with enough trials, the estimate converges toward the true probability', 'That exactly 5,000 trials is always required', 'That the simulation was designed incorrectly'], correct: 1, exp: 'This is exactly what the law of large numbers predicts: as trial count grows very large, the long-run relative frequency approaches the true probability.' },
        { q: 'Which scenario would require "no repeats allowed" in its simulation design?', opts: ['Rolling the same die 6 times', 'Randomly selecting 5 different students from a class to form a committee (no student picked twice)', 'Flipping the same coin 10 times', 'Shooting 8 free throws in a row'], correct: 1, exp: 'Selecting distinct individuals for a committee, where no one can be chosen twice, is sampling without replacement — repeats must not be allowed.' },
        { q: 'Which scenario would require "repeats allowed" in its simulation design?', opts: ['Simulating whether each of 20 independent customers makes a purchase', 'Selecting 3 distinct winners from a raffle drum', 'Dealing the top 5 cards from a single shuffled deck (no card dealt twice)', 'Randomly assigning 4 different people to 4 different prizes'], correct: 0, exp: 'Each customer’s purchase decision is independent of the others, so repeats should be allowed — unlike the other options, which involve selecting distinct individuals without replacement.' },
        { q: 'A single simulation trial for "at least 3 heads in 5 tosses" produces the sequence 2,1,2,1,1 (1=heads, 2=tails). Is this trial a success?', opts: ['Cannot be determined without more trials', 'No — there are only 2 ones (heads)', 'Yes — there are 3 ones (heads)', 'Yes, because the sequence contains a 1'], correct: 2, exp: 'The sequence 2,1,2,1,1 contains three 1s (heads: positions 2, 4, 5), which meets the "3 or more heads" success condition.' },
        ...
        { q: 'A simulation design assigns 00–59 to "success" (60 numbers) for an event with a real-world probability of 55%. What is wrong with this design?', opts: ['Nothing — the numbers just need to add up to 100', '60 numbers represents 60%, not 55%, so the simulation would overestimate the true probability', 'This design is fine as long as enough trials are run', 'The numbers should have been letters instead'], correct: 1, exp: '60 out of 100 numbers represents a 60% chance, not the intended 55% — running more trials would not fix a probability that was set up incorrectly in the first place.' },
        { q: 'Why is running only one trial of a simulation almost meaningless on its own?', opts: ['Because one trial gives either 0% or 100%, neither of which reflects the true long-run probability except by coincidence', 'Because a single trial can only ever show a success', 'Because a single trial always matches the true probability exactly', 'Because simulations require a computer to run even one trial'], correct: 0, exp: 'One trial is binary — success or failure — so it can only produce 0% or 100%, which almost never equals the true long-run probability. Only repeated trials, per the law of large numbers, approach the truth.' }
      ]
    }
  }
});
...
registerChapters({
  '2-4': {
    ...
    sections: [
      ...
      /* ---------------- 8. QUIZ ---------------- */
      {
        ...
        questions: [
          ...
          { q: 'What must be true about the outcomes in a sample space to use P(E) = favorable ÷ total?', opts: ['They must be independent', 'They must all be numbers', 'There must be exactly 2 of them', 'They must be equally likely'], correct: 3, exp: 'The equally-likely-outcomes formula only applies when every outcome in the sample space has the same probability.' },
          ...
          { q: 'Which of these is a valid probability?', opts: ['1.15', '−0.25', '0.72', '150%'], correct: 2, exp: 'Probabilities must fall between 0 and 1 inclusive (0% to 100%). 0.72 is the only valid value listed.' },
          ...
          { q: 'A bag has 4 blue and 6 orange marbles (10 total). What is P(not blue)?', opts: ['1/10', '6/10', '4/10', '10/4'], correct: 1, exp: 'P(blue) = 4/10, so P(not blue) = 1 − 4/10 = 6/10 — which also equals the direct count of orange marbles, 6/10.' }
        ]
      },
    ...
    homework: {
      estTime: '~30 min',
      questions: [
        { q: 'The sample space of flipping a coin twice and recording the sequence of heads/tails is:', opts: ['{HH, HT, TH, TT}', '{2 heads, 2 tails}', '{0, 1, 2}', '{H, T}'], correct: 0, exp: 'Recording the sequence of two flips gives four distinct, non-overlapping outcomes: HH, HT, TH, TT.' },
        { q: 'What is required before you can use P(E) = (favorable outcomes) / (total outcomes)?', opts: ['The event must be a joint probability', 'The sample space must contain fewer than 10 outcomes', 'The event must involve exactly two outcomes', 'All outcomes in the sample space must be equally likely'], correct: 3, exp: 'This shortcut formula only works when every outcome in the sample space has an equal chance of occurring.' },
        { q: 'A spinner has 5 equal sections numbered 1–5. What is P(spinning a number greater than 3)?', opts: ['2/5', '1/5', '3/5', '4/5'], correct: 0, exp: 'Numbers greater than 3 are 4 and 5 — 2 favorable outcomes out of 5 total: 2/5.' },
        { q: 'If P(a randomly chosen student plays a sport) = 0.68, what is P(does not play a sport)?', opts: ['Cannot be determined without more information', '0.32', '0.68', '1.68'], correct: 1, exp: 'Complement: 1 − 0.68 = 0.32.' },
        ...
        { q: 'A jar has 6 red, 4 blue, and 10 green marbles (20 total). What is P(blue)?', opts: ['4/10', '10/20', '4/20', '6/20'], correct: 2, exp: 'Favorable (blue = 4) over total (20): 4/20 = 1/5 = 20%.' },
        ...
        { q: 'When you roll two fair six-sided dice and record the sum, how many total (die 1, die 2) outcomes are in the sample space, and are all sums equally likely?', opts: ['36 outcomes; no, the sums are not equally likely even though the individual pairs are', '36 outcomes; yes, all sums are equally likely', '11 outcomes; yes, all sums are equally likely', '6 outcomes; no, the sums are not equally likely'], correct: 0, exp: 'There are 36 equally likely (die 1, die 2) pairs, but because different sums can be made in different numbers of ways, the 11 possible sums (2–12) are not equally likely.' },
        { q: 'How many of the 36 (die 1, die 2) outcomes produce a sum of 8?', opts: ['6', '3', '5', '4'], correct: 2, exp: 'Sum of 8: (2,6),(3,5),(4,4),(5,3),(6,2) — 5 outcomes.' },
        ...
        { q: 'A two-way table of 500 people crosses "handedness" (left/right) with "sport played" (soccer/basketball/none). The "left-handed" row totals 60. What is P(left-handed)?', opts: ['60%, without needing to divide', 'Cannot be determined without more of the table', '500/60', '60/500'], correct: 3, exp: 'This is a marginal probability: the row total (60) divided by the grand total (500).' },
        { q: 'In the same table, 500 total people, 18 are both left-handed and play soccer. What is P(left-handed ∩ soccer)?', opts: ['60/500', '18/60', '18/500', '500/18'], correct: 2, exp: 'A joint probability always divides the interior cell by the grand total: 18/500.' },
        { q: 'Which of these correctly describes what P(E) notation means?', opts: ['The number of trials needed to observe E', 'The population size of event E', 'P multiplied by E', 'The probability, percentage, or proportion of event E occurring'], correct: 3, exp: 'P(E) is notation for "the probability of E" — the P stands for probability/percentage/proportion, and it is never multiplication.' },
        ...
        { q: 'What is the complement of "rolling a number less than 3" on a fair six-sided die?', opts: ['Rolling a number less than 3 again', 'Rolling a 3, 4, 5, or 6', 'Rolling exactly a 3', 'There is no complement for this event'], correct: 1, exp: 'The complement of "less than 3" (i.e., 1 or 2) is everything else in the sample space: 3, 4, 5, or 6.' },
        { q: 'P(sum ≤ 4) when rolling two fair six-sided dice equals:', opts: ['1/36', '6/36', '4/36', '3/36'], correct: 1, exp: 'Sums of 2, 3, and 4 come from (1,1); (1,2),(2,1); and (1,3),(2,2),(3,1) — that’s 1+2+3 = 6 outcomes out of 36.' },
        { q: 'A bag of 50 lottery tickets has 2 winning tickets. One ticket is drawn at random. What is P(winning) and is the equally-likely-outcomes formula valid here?', opts: ['2/48; yes', '2/50; no, tickets are never equally likely', '48/50; yes', '2/50; yes, each ticket has an equal chance of being drawn'], correct: 3, exp: 'Each of the 50 tickets has an equal 1/50 chance of being drawn, so the formula applies directly: 2 favorable out of 50 total.' },
        ...
        { q: 'Why can’t you directly apply P(E) = favorable ÷ total to find P(sum = 7) by treating "7" as 1 outcome out of 11 possible sums (2 through 12)?', opts: ['Because probability formulas never apply to two-dice problems', 'Because sums can only range from 2 to 11, not 12', 'Because 7 is always the most common sum by definition, so no calculation is needed', 'Because the 11 possible sums are not equally likely — you must count the 36 equally likely (die 1, die 2) pairs instead'], correct: 3, exp: 'The equally-likely-outcomes formula requires equally likely outcomes — and the 11 sums are not equally likely, even though the 36 underlying (die 1, die 2) pairs are. You must count favorable pairs, not favorable sums.' }
      ]
    }
  }
});
  ...
  '2-5': {
    ...
    sections: [
      ...
      /* ---------------- 8. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'Joint probability P(A ∩ B) refers to:', opts: ['The probability that neither A nor B occurs', 'The probability that A and B occur at the same time', 'The probability of A given B', 'The probability that A occurs, ignoring B entirely'], correct: 1, exp: 'Joint probability is specifically about A and B happening together — pictured as the overlap region on a Venn diagram.' },
          { q: 'On a Venn diagram, mutually exclusive events are shown as:', opts: ['Two circles with some overlap', 'A single circle', 'Two circles with no overlap at all', 'Two circles that overlap completely'], correct: 2, exp: 'Mutually exclusive (disjoint) events can never happen together, so their circles never touch — zero overlap.' },
          { q: 'If P(A ∩ B) = 0.08, are A and B mutually exclusive?', opts: ['Yes, because 0.08 is a small number', 'Yes, since it’s less than 0.5', 'Cannot be determined', 'No — mutually exclusive requires P(A ∩ B) to equal exactly 0'], correct: 3, exp: 'Mutual exclusivity requires zero overlap — any nonzero joint probability, even a small one, means the events are not mutually exclusive.' },
          { q: 'A 2×2 table has a grand total of 120, row totals 50 and 70, column totals 45 and 75, and a top-left cell of 30. What is the bottom-left cell?', opts: ['15', '35', '25', '20'], correct: 0, exp: 'The left column totals 45, and its top cell is 30, so the bottom-left cell is 45 − 30 = 15.' },
          { q: 'Two events, "rolling a 3" and "rolling an even number" on a single die roll, are:', opts: ['Mutually exclusive, since 3 is odd and evens are different', 'Not mutually exclusive, since a die could show both at once', 'Impossible to compare', 'The same event'], correct: 0, exp: 'A single roll can’t be both 3 (odd) and even at the same time — these two events are mutually exclusive, P(both) = 0.' },
          { q: 'Two events, "being a sophomore" and "playing varsity soccer," are most likely:', opts: ['Impossible to define', 'Mutually exclusive, since sophomores can’t play sports', 'Not mutually exclusive — a student could easily be both', 'Always independent'], correct: 2, exp: 'A student can absolutely be both a sophomore and a varsity soccer player at the same time — there’s no rule preventing overlap, so these are not mutually exclusive.' },
          { q: '150 customers: 70 male, 80 female. 22 males ordered iced coffee. What is P(Male ∩ Iced)?', opts: ['22/70', '22/150', '70/150', '22/80'], correct: 1, exp: 'Joint probability always divides by the grand total: 22/150 ≈ 14.7%.' },
          { q: 'In a 2×2 table, if the "both" cell and the "neither" cell are both 0, what can you conclude?', opts: ['Nothing can be concluded', 'The table has an error', 'The two events are independent, not mutually exclusive', 'The two row/column events must be mutually exclusive'], correct: 3, exp: 'A "both" cell of 0 directly means P(A ∩ B) = 0 — the definition of mutually exclusive.' }
        ]
      },
    ...
    homework: {
      estTime: '~30 min',
      questions: [
        { q: 'Joint probability P(A ∩ B) is best described as:', opts: ['The probability that A and B occur at the same time', 'The probability of A given that B occurred', 'The probability of A or B, but not both', 'The probability that neither A nor B occurs'], correct: 0, exp: 'Joint probability specifically measures A and B happening together.' },
        { q: 'On a Venn diagram, the overlap between circle A and circle B represents:', opts: ['P(A ∩ B)', 'P(A) alone', 'P(B) alone', 'P(neither A nor B)'], correct: 0, exp: 'The overlapping region is exactly the joint probability P(A ∩ B).' },
        { q: 'Two events are mutually exclusive if and only if:', opts: ['P(A ∩ B) = 0', 'P(A ∩ B) = 0.5', 'P(A ∩ B) = 1', 'P(A) = P(B)'], correct: 0, exp: 'Mutually exclusive (disjoint) events have zero probability of occurring together: P(A ∩ B) = 0.' },
        { q: 'A die is rolled once. Are "rolling a 5" and "rolling an odd number" mutually exclusive?', opts: ['Yes, since they’re different phrases', 'Yes, since 5 only comes up rarely', 'Cannot be determined', 'No — 5 is itself an odd number, so both events happen together whenever you roll a 5'], correct: 3, exp: 'Since 5 is odd, rolling a 5 automatically satisfies "rolling an odd number" too — these events overlap, so they are NOT mutually exclusive.' },
        { q: 'A die is rolled once. Are "rolling a 2" and "rolling a 5" mutually exclusive?', opts: ['Yes — a single roll can’t show both a 2 and a 5 at the same time', 'Cannot be determined without more rolls', 'No, both are possible outcomes', 'Only if the die is unfair'], correct: 0, exp: 'A single die roll produces exactly one number, so it’s impossible to roll both a 2 and a 5 simultaneously — these events are mutually exclusive.' },
        { q: 'A survey of 100 people crosses "owns a cat" with "owns a dog." 12 people own both. Are "owns a cat" and "owns a dog" mutually exclusive?', opts: ['Cannot be determined from this information', 'Yes, because cats and dogs are different animals', 'Yes, since most pet owners choose one type', 'No — 12 people own both, so P(cat ∩ dog) = 12/100 ≠ 0'], correct: 3, exp: 'Since 12 people own both, the joint probability is nonzero, which means the events are NOT mutually exclusive.' },
        { q: 'A 2×2 table has grand total 200, row totals 90 and 110, column totals 75 and 125. The top-left cell (row 1, column 1) is 40. What is the top-right cell?', opts: ['75', '35', '50', '90'], correct: 2, exp: 'Row 1 totals 90, and its first cell is 40, so the second cell in row 1 is 90 − 40 = 50.' },
        ...
        { q: 'Continuing the same table, what is the bottom-right cell?', opts: ['110', '75', '85', '65'], correct: 1, exp: 'Row 2 totals 110, and its first (bottom-left) cell is 35, so the bottom-right cell is 110 − 35 = 75. Column 2 totals 125 minus the top-right cell (50) also gives 75 — both methods must agree, and they do.' },
        ...
        { q: 'A 2×2 table shows "both" = 0 for events C and D. What can you immediately conclude?', opts: ['C and D have equal probability', 'C and D are independent', 'The table must contain an error', 'C and D are mutually exclusive'], correct: 3, exp: 'A "both" cell of exactly 0 is the defining property of mutually exclusive events.' },
        { q: 'A survey asks students to pick exactly one favorite season (never more than one). Are "prefers summer" and "prefers winter" mutually exclusive?', opts: ['Only if fewer than 50 students were surveyed', 'Yes — since each student picks only one favorite, nobody can be counted under both', 'No, many students like both seasons equally', 'Cannot be determined without survey data'], correct: 1, exp: 'The "pick exactly one" constraint guarantees zero overlap between any two different favorite-season categories — they are mutually exclusive by design.' },
        ...
        { q: '200 people were asked about owning a car and owning a bike. 140 own a car, 90 own a bike, and 30 own neither. How many own both?', opts: ['30', '40', '60', '70'], correct: 2, exp: 'At least one = 200 − 30 = 170. Both = car total + bike total − at least one = 140 + 90 − 170 = 60.' },
        { q: 'Which pair of events is most clearly NOT mutually exclusive?', opts: ['"Owns a smartphone" and "owns a laptop"', '"Rolling a 1" and "rolling a 6" on one die roll', '"Being born in January" and "being born in July"', '"Drawing a heart" and "drawing a spade" from one card'], correct: 0, exp: 'Owning a smartphone and owning a laptop can easily happen for the same person — these are not mutually exclusive, unlike the other options, which are all genuinely impossible to have both at once.' },
        { q: 'On a Venn diagram, if circle A and circle B are drawn with zero overlap, what does that tell you about P(A ∩ B)?', opts: ['P(A ∩ B) = 1', 'P(A ∩ B) = 0', 'P(A ∩ B) equals P(A) + P(B)', 'P(A ∩ B) is undefined'], correct: 1, exp: 'Zero overlap on a Venn diagram directly represents P(A ∩ B) = 0 — the visual definition of mutually exclusive events.' },
        { q: 'A 2×2 table has one row totaling 50, with its two interior cells being 18 and an unknown value. What is the unknown value?', opts: ['68', '50', '32', '18'], correct: 2, exp: 'The row total (50) minus the known cell (18) gives the unknown cell: 50 − 18 = 32.' },
        ...
        { q: 'A study finds P(likes coffee ∩ likes tea) = 0.15 among 300 people surveyed. Are "likes coffee" and "likes tea" mutually exclusive?', opts: ['Yes, since 0.15 is fairly small', 'No — any joint probability other than exactly 0 means the events are not mutually exclusive', 'Cannot be determined without more data', 'Yes, because most people prefer one drink over the other'], correct: 1, exp: 'A joint probability of 0.15 is nonzero, so by definition, these events are not mutually exclusive — no matter how small the overlap is.' },
        { q: 'Why is it useful to build a full 2×2 table (the box method) instead of just reasoning about mutual exclusivity from a written description?', opts: ['It’s never useful — reading the description is always sufficient', 'The box method only works for exactly two categories', 'It replaces the need to know row and column totals', 'It lets you calculate the exact joint probability (not just yes/no) and verify your reasoning with numbers that must add up consistently across every row and column'], correct: 3, exp: 'The box method gives you the exact numeric joint probability, not just a yes/no answer, and every row and column must be internally consistent, which catches errors that pure verbal reasoning could miss.' }
      ]
    }
  }
});
  ...
  '2-6': {
    ...
    sections: [
      ...
      /* ---------------- 8. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'P(A | B) is read as:', opts: ['The probability of A and B', 'The probability of A or B', 'The probability of A given B', 'The probability of B given A'], correct: 2, exp: 'The bar means "given" — P(A | B) is "the probability of A, given that B has occurred."' },
          { q: 'The conditional probability formula is:', opts: ['P(A | B) = P(A) × P(B)', 'P(A | B) = P(B) ÷ P(A ∩ B)', 'P(A | B) = P(A) ÷ P(A ∩ B)', 'P(A | B) = P(A ∩ B) ÷ P(B)'], correct: 3, exp: 'The numerator is the joint probability P(A ∩ B); the denominator is only the condition, P(B).' },
          { q: 'In a two-way table, "given that a person purchased food, what is the probability they root for the home team?" means your denominator should be:', opts: ['The grand total of everyone surveyed', 'The number of people who did NOT purchase food', 'Only the people who purchased food', 'Only the people rooting for the home team'], correct: 2, exp: 'The condition (purchased food) restricts your denominator to only that group.' },
          { q: 'The general multiplication rule states:', opts: ['P(A ∩ B) = P(A) + P(B)', 'P(A ∩ B) = P(A) × P(B | A)', 'P(A ∩ B) = P(A) ÷ P(B)', 'P(A ∩ B) = P(A | B) × P(B | A)'], correct: 1, exp: 'To find the probability of A and B both happening, multiply P(A) by the conditional probability of B given that A already happened.' },
          { q: 'A jar has 8 red and 12 blue marbles (20 total). Two are drawn without replacement. What is P(2nd is blue | 1st was blue)?', opts: ['11/19', '12/19', '12/20', '11/20'], correct: 0, exp: 'After removing one blue marble, 11 blue marbles remain out of 19 total remaining marbles.' },
          { q: 'On a tree diagram, if Branch 1 has probability 0.3 and the sub-branch after it has probability 0.5, what is the joint probability at that endpoint?', opts: ['0.8', '0.15', '0.5', '0.3'], correct: 1, exp: 'Multiply down the branches: 0.3 × 0.5 = 0.15.' },
          { q: 'A factory’s Machine A makes 70% of products with a 2% defect rate; Machine B makes 30% with a 5% defect rate. What is the overall probability a random product is defective?', opts: ['0.014 + 0.015 = 0.029', '0.02 + 0.05 = 0.07', '0.07', '0.7 × 0.3 = 0.21'], correct: 0, exp: 'Add the two joint probabilities: (0.70 × 0.02) + (0.30 × 0.05) = 0.014 + 0.015 = 0.029, or 2.9%.' },
          { q: 'Why can’t you just add the two conditional defect rates (4% and 10%) directly to find the overall defect probability in the light bulb example?', opts: ['Because 4% and 10% are already the final answer', 'Because percentages can never be added', 'Because defect rates are never conditional', 'Because each rate is conditional on a specific machine, and you must weight it by the chance of coming from that machine first'], correct: 3, exp: 'A defect happening at a 4% rate only applies within the branch where the bulb already came from Machine A — you must multiply by P(Machine A) first, then add the two resulting joint probabilities.' }
        ]
      },
    ...
    homework: {
      estTime: '~35 min',
      questions: [
        { q: 'P(A | B) is best translated into words as:', opts: ['The probability of A and B happening together', 'The probability that neither A nor B happens', 'The probability of A, given that B has already happened', 'The probability of B, given that A has already happened'], correct: 2, exp: 'The bar means "given" — whatever follows it (B) is the condition that has already occurred.' },
        { q: 'The correct conditional probability formula is:', opts: ['P(A | B) = P(A ∩ B) ÷ P(B)', 'P(A | B) = P(A ∩ B) ÷ P(A)', 'P(A | B) = P(A) × P(B)', 'P(A | B) = P(B) ÷ P(A ∩ B)'], correct: 0, exp: 'Joint probability divided by the probability of the condition alone.' },
        { q: 'A two-way table crosses "plays chess" with "plays checkers" for 400 people. 150 play chess, and of those, 90 also play checkers. What is P(checkers | chess)?', opts: ['150/90', '150/400', '90/150', '90/400'], correct: 2, exp: 'The condition (plays chess) restricts the denominator to the 150 chess players.' },
        { q: 'Using the same data, what is P(chess ∩ checkers)?', opts: ['90/150', '400/90', '90/400', '150/400'], correct: 2, exp: 'Joint probability always divides by the grand total: 90/400.' },
        { q: '68% of drivers have insurance. Of insured drivers, 95% pass inspection. What is P(insured ∩ passes inspection)?', opts: ['0.68 ÷ 0.95 = 0.716', '0.68 + 0.95 = 1.63', '0.95 ÷ 0.68 = 1.397', '0.68 × 0.95 = 0.646'], correct: 3, exp: 'General multiplication rule: P(insured ∩ passes) = P(insured) × P(passes | insured) = 0.68 × 0.95 = 0.646.' },
        { q: 'A bag has 5 red and 7 white balls (12 total). Two are drawn without replacement. What is P(both red)?', opts: ['5/12 × 4/12', '5/12 × 4/11', '5/12 + 4/11', '5/12 × 5/12'], correct: 1, exp: 'First draw: 5/12. Second draw (without replacement, one red already removed): 4/11. Multiply using the general multiplication rule.' },
        ...
        { q: 'A factory has two machines. Machine X makes 55% of products with a 3% defect rate. Machine Y makes 45% with a 6% defect rate. What is the overall probability a random product is defective?', opts: ['0.09', '0.55 × 0.45', '0.03 + 0.06 = 0.09', '0.0165 + 0.027 = 0.0435'], correct: 3, exp: '(0.55 × 0.03) + (0.45 × 0.06) = 0.0165 + 0.027 = 0.0435, or 4.35%.' },
        { q: 'Using the same factory (Machine X: 55%, 3% defective; Machine Y: 45%, 6% defective; overall defect rate 4.35%), what is P(came from Machine Y | defective)?', opts: ['0.45', '0.027 ÷ 0.0435 ≈ 0.621', '0.0165 ÷ 0.0435 ≈ 0.379', '0.06 ÷ 0.0435 ≈ 1.379'], correct: 1, exp: 'P(Y | defective) = P(Y ∩ defective) ÷ P(defective) = 0.027 ÷ 0.0435 ≈ 62.1%.' },
        ...
        { q: 'Using the same disease-testing data (P(tests positive) = 0.067), what is P(has the disease | tests positive)?', opts: ['0.02', '0.018 ÷ 0.067 ≈ 0.269', '0.90', '0.90 ÷ 0.067 ≈ 13.4'], correct: 1, exp: 'P(disease | positive) = P(disease ∩ positive) ÷ P(positive) = 0.018 ÷ 0.067 ≈ 26.9%.' },
        ...
        { q: 'A weather station finds 30% of days are cloudy. Of cloudy days, 40% have rain. What is P(cloudy ∩ rain)?', opts: ['0.40', '0.70', '0.30', '0.12'], correct: 3, exp: 'P(cloudy ∩ rain) = P(cloudy) × P(rain | cloudy) = 0.30 × 0.40 = 0.12.' },
        { q: 'A deck-like game has 15 tokens: 6 gold, 5 silver, 4 bronze. Two tokens are drawn without replacement. What is P(both gold)?', opts: ['6/15 × 6/15', '6/15 × 6/14', '6/15 × 5/14', '6/15 + 5/14'], correct: 2, exp: 'First draw: 6/15. Second draw (one gold token already removed): 5 gold left out of 14 total remaining: 6/15 × 5/14.' },
        ...
        { q: 'Given P(A) = 0.5 and P(A ∩ B) = 0.2, what is P(B | A)?', opts: ['0.2 ÷ 0.5 = 0.4', '0.5 ÷ 0.2 = 2.5', '0.2 × 0.5 = 0.1', '0.5 − 0.2 = 0.3'], correct: 0, exp: 'P(B | A) = P(A ∩ B) ÷ P(A) = 0.2 ÷ 0.5 = 0.4.' },
        { q: 'A tree diagram has 2 first-stage branches and 2 second-stage branches under each, for 4 total endpoints. What must the 4 endpoint (joint) probabilities sum to?', opts: ['1', 'It depends on the specific probabilities', '0', '0.5'], correct: 0, exp: 'The 4 endpoints cover every possible outcome of the two-stage process, so their joint probabilities must sum to exactly 1.' },
        { q: 'Why is a tree diagram especially useful for a problem like "1% of a population has a disease, and a test has different accuracy for sick vs. healthy people"?', opts: ['Tree diagrams only work for exactly 1% probabilities', 'It organizes each conditional probability (test accuracy) under the correct starting branch (disease status), preventing you from mixing up which rate applies to which group', 'It replaces the need for the general multiplication rule entirely', 'It avoids the need for any percentages'], correct: 1, exp: 'The tree keeps each conditional test-accuracy rate attached to the correct disease-status branch, which is exactly what prevents the common error of just adding the accuracy rates together.' },
  ...
  '2-7': {
    ...
    sections: [
      ...
      /* ---------------- 8. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'Events A and B are independent if and only if:', opts: ['P(A ∩ B) = 0', 'P(A ∪ B) = 1', 'P(A | B) = P(A)', 'P(A) = P(B)'], correct: 2, exp: 'Independence means the condition changes nothing: P(A | B) equals the plain marginal P(A).' },
          { q: 'P(A ∩ B) = P(A) × P(B) is valid:', opts: ['Only when A and B are mutually exclusive', 'Always, for any two events', 'Only when P(A) = P(B)', 'Only when A and B are known to be independent'], correct: 3, exp: 'This shortcut only holds once independence has been established — otherwise you need the general multiplication rule.' },
          { q: 'The union symbol ∪ means:', opts: ['Or', 'And', 'Given', 'Not'], correct: 0, exp: '∪ means "or" — A, or B, or both.' },
          { q: 'The addition rule for P(A ∪ B) is:', opts: ['P(A) + P(B)', 'P(A) + P(B) − P(A ∩ B)', 'P(A) × P(B)', 'P(A) − P(B)'], correct: 1, exp: 'You must subtract the overlap once so it isn’t counted twice.' },
          { q: 'P(A) = 0.4, P(B) = 0.5, and A, B are independent. What is P(A ∩ B)?', opts: ['0.45', '0.1', '0.9', '0.2'], correct: 3, exp: 'Since they’re independent: P(A ∩ B) = P(A) × P(B) = 0.4 × 0.5 = 0.2.' },
          { q: 'P(A) = 0.3, P(B) = 0.4, P(A ∩ B) = 0.1. What is P(A ∪ B)?', opts: ['0.7', '0.6', '0.5', '0.8'], correct: 1, exp: 'P(A ∪ B) = 0.3 + 0.4 − 0.1 = 0.6.' },
    ...
    homework: {
      estTime: '~35 min',
      questions: [
        { q: 'Two events A and B are independent when:', opts: ['Knowing B occurred does not change the probability of A', 'P(A ∩ B) = 0', 'A and B always occur together', 'P(A) + P(B) = 1'], correct: 0, exp: 'Independence means the condition has zero effect on the other event’s probability.' },
        { q: 'Which formula is valid ONLY when A and B are already known to be independent?', opts: ['P(A ∩ B) = P(A) × P(B)', 'P(A ∪ B) = P(A) + P(B) − P(A ∩ B)', 'P(A | B) = P(A ∩ B) / P(B)', 'P(not A) = 1 − P(A)'], correct: 0, exp: 'This multiplication shortcut requires independence — otherwise you must use the general multiplication rule with a conditional probability.' },
        { q: 'A two-way table shows P(likes hiking) = 55% overall, and P(likes hiking | owns a dog) = 55%. What does this tell you?', opts: ['Owning a dog and liking hiking are not independent', 'The table must contain an error', 'Owning a dog causes a dislike of hiking', 'Owning a dog and liking hiking are independent'], correct: 3, exp: 'Since the conditional probability exactly equals the marginal probability, adding the condition changed nothing — the events are independent.' },
        { q: 'P(A) = 0.5, P(B) = 0.2, A and B independent. What is P(A ∩ B)?', opts: ['0.7', '2.5', '0.1', '0.3'], correct: 2, exp: 'P(A ∩ B) = P(A) × P(B) = 0.5 × 0.2 = 0.1, valid since they’re independent.' },
        ...
        { q: 'P(A) = 0.35, P(B) = 0.5, P(A ∩ B) = 0.15. What is P(A ∪ B)?', opts: ['0.85', '0.7', '0.5', '1.0'], correct: 1, exp: 'P(A ∪ B) = 0.35 + 0.5 − 0.15 = 0.7.' },
        ...
        { q: 'P(A) = 0.3, P(A ∪ B) = 0.75, and A, B are mutually exclusive. What is P(B)?', opts: ['1.05', '0.75', '0.45', '0.25'], correct: 2, exp: 'Mutually exclusive means P(A ∩ B) = 0, so 0.75 = 0.3 + P(B) − 0, giving P(B) = 0.45.' },
        { q: 'P(A) = 0.4, P(A ∪ B) = 0.7, and A, B are independent. What is P(B)?', opts: ['0.5', '0.6', '0.3', '0.42'], correct: 0, exp: 'Since independent, P(A ∩ B) = 0.4 × P(B). So 0.7 = 0.4 + P(B) − 0.4P(B) = 0.4 + 0.6P(B), giving P(B) = 0.3/0.6 = 0.5.' },
        { q: 'If P(A ∪ B) = 0.82, what is P(neither A nor B)?', opts: ['Cannot be determined', '0.18', '0.5', '0.82'], correct: 1, exp: '"Neither" is the complement of the union: 1 − 0.82 = 0.18.' },
        { q: 'A survey of 400 people: P(owns a tablet) = 45%, P(owns a laptop) = 70%, P(owns both) = 35%. What proportion own at least one of the two devices?', opts: ['1.15 (115%)', '80%', '35%', '10%'], correct: 1, exp: 'P(tablet ∪ laptop) = 0.45 + 0.70 − 0.35 = 0.80, or 80%.' },
        { q: 'Using the same survey, what proportion own neither a tablet nor a laptop?', opts: ['20%', '35%', '65%', '80%'], correct: 0, exp: 'P(neither) = 1 − P(at least one) = 1 − 0.80 = 0.20, or 20%.' },
        { q: 'A two-way table: P(has a pet) = 60%. P(has a pet | lives in a house) = 60%. P(has a pet | lives in an apartment) = 60%. What can you conclude?', opts: ['Having a pet is associated with housing type', 'The table contains a calculation error', 'Having a pet is independent of housing type, since the conditional probabilities all match the marginal', 'Cannot be determined without raw counts'], correct: 2, exp: 'Since every conditional probability equals the marginal 60%, housing type has zero effect on pet ownership — independence confirmed.' },
        { q: 'P(rolls a 6) = 1/6 on a single fair die. Two dice are rolled. Are "first die shows 6" and "second die shows 6" independent events?', opts: ['No, because dice influence each other', 'Cannot be determined without rolling many times', 'Yes — the outcome of one die has no effect on the other', 'Only if both dice are the same color'], correct: 2, exp: 'Separate dice rolls are physically independent — one die’s result has no bearing on the other’s.' },
        { q: 'Using independence, what is P(both dice show 6) when rolling two fair six-sided dice?', opts: ['1/36', '2/6', '1/12', '1/6'], correct: 0, exp: 'Since the rolls are independent: P(both 6) = P(die 1 = 6) × P(die 2 = 6) = 1/6 × 1/6 = 1/36.' },
        ...
        { q: 'A different store finds P(buys milk) = 0.5, P(buys eggs) = 0.4, P(buys both) = 0.25. Are these independent?', opts: ['Yes, because both probabilities are positive', 'Yes, since 0.25 is close to both 0.5 and 0.4', 'Cannot be determined without more data', 'No — 0.5 × 0.4 = 0.20, which does not equal the given 0.25'], correct: 3, exp: 'The independence shortcut predicts P(both) = 0.5 × 0.4 = 0.20, but the actual value is 0.25 — since these don’t match, the events are NOT independent.' },
        { q: 'P(A) = 0.6, P(B) = 0.35, P(A ∪ B) = 0.83. What is P(A ∩ B)?', opts: ['0.48', '0.12', '0.95', '0.23'], correct: 1, exp: 'Rearranging the addition rule: P(A ∩ B) = P(A) + P(B) − P(A ∪ B) = 0.6 + 0.35 − 0.83 = 0.12.' },
  ...
  '2-8': {
    ...
    sections: [
      ...
      /* ---------------- 7. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'A random variable must have outcomes that are:', opts: ['Numbers', 'Always between 0 and 1', 'Always whole numbers only', 'Words or categories'], correct: 0, exp: 'A random variable is only defined when the outcomes of a random process are numerical.' },
          { q: 'The number of text messages a person sends in a day is best classified as:', opts: ['Not a random variable', 'A discrete random variable', 'A probability distribution', 'A continuous random variable'], correct: 1, exp: 'The count of messages is listable and finite (0, 1, 2, 3...) — a discrete random variable.' },
          { q: 'The exact weight of a randomly selected apple, measured with a precise scale, is best classified as:', opts: ['A continuous random variable', 'A joint probability', 'A discrete random variable', 'Not a random variable'], correct: 0, exp: 'Weight is measured, not counted, and can take any value on an interval, including decimals — continuous.' },
          { q: 'A discrete probability distribution lists P(0)=0.1, P(1)=0.4, P(2)=x, P(3)=0.2. What must x equal?', opts: ['0.7', '0.3', '1.0', '0.1'], correct: 1, exp: 'All probabilities must sum to 1: x = 1 − 0.1 − 0.4 − 0.2 = 0.3.' },
          { q: 'On a probability tree, two different branches both end with the random variable equal to 3. To find P(X=3), you should:', opts: ['Subtract one from the other', 'Use only the larger of the two probabilities', 'Add the two branch probabilities together', 'Multiply the two branch probabilities together'], correct: 2, exp: 'Different paths that lead to the same outcome value get added together.' },
          { q: 'Within a single tree branch (e.g., "wins race 1, then wins race 2"), how do you combine the probabilities along that one path?', opts: ['Average them', 'Divide them', 'Multiply them', 'Add them'], correct: 2, exp: 'Multiply down a single path — that’s the general multiplication rule, chained across each stage.' },
          { q: 'A horse wins race 1 with probability 0.7. If it wins race 1, it wins race 2 with probability 0.8. What is P(wins both races)?', opts: ['0.7 + 0.8 = 1.5', '0.7 ÷ 0.8 = 0.875', '0.8 − 0.7 = 0.1', '0.7 × 0.8 = 0.56'], correct: 3, exp: 'Multiply down the branch: P(win 1 ∩ win 2) = 0.7 × 0.8 = 0.56.' },
          { q: 'A distribution shows P(0)=0.15, P(1)=0.35, P(2)=0.30, P(3)=0.20. What is P(X ≥ 2)?', opts: ['0.70', '0.30', '0.20', '0.50'], correct: 3, exp: 'P(X ≥ 2) = P(2) + P(3) = 0.30 + 0.20 = 0.50.' }
        ]
      },
    ...
    homework: {
      estTime: '~35 min',
      questions: [
        { q: 'Which of these is a valid random variable?', opts: ['The color of a randomly selected car', 'The brand name of a randomly selected car', 'The number of doors on a randomly selected car', 'Whether a car is a sedan or an SUV'], correct: 2, exp: 'The number of doors is a numerical outcome of a random process — the other options are all categories, not numbers.' },
        { q: 'The number of goals scored in a randomly selected soccer match is best classified as:', opts: ['Discrete', 'Not a random variable', 'A probability', 'Continuous'], correct: 0, exp: 'Goals are counted in whole numbers and are listable — discrete.' },
        { q: 'The exact time (in seconds) it takes a runner to finish a race, measured with a stopwatch, is best classified as:', opts: ['Discrete', 'A probability distribution', 'Not a random variable', 'Continuous'], correct: 3, exp: 'Time is measured and can take any value on an interval, including many decimal places — continuous.' },
        ...
        { q: 'A distribution shows P(0)=0.4, P(1)=0.6. If two independent plays are combined into a total, what is P(total = 0)?', opts: ['1.0', '0.24', '0.4', '0.16'], correct: 3, exp: 'Both plays must be 0: 0.4 × 0.4 = 0.16.' },
        { q: 'Using the same distribution (P(0)=0.4, P(1)=0.6) played twice, what is P(total = 1)?', opts: ['0.24', '0.48', '0.6', '0.36'], correct: 1, exp: 'Two paths: (0 then 1) or (1 then 0): 0.4×0.6 + 0.6×0.4 = 0.24 + 0.24 = 0.48.' },
        { q: 'Using the same distribution played twice, what is P(total = 2)?', opts: ['0.6', '0.36', '0.16', '0.48'], correct: 1, exp: 'Both plays must be 1: 0.6 × 0.6 = 0.36. Check: 0.16 + 0.48 + 0.36 = 1.00 ✓' },
        ...
        { q: 'On a probability tree, why do you sometimes need to ADD probabilities from two different branches to find P(X = some value)?', opts: ['Because multiplication only works for the first branch', 'Because two different paths through the tree can result in the same value of the random variable', 'Because addition is always required in probability', 'You never need to add branch probabilities'], correct: 1, exp: 'When two distinct tree paths both produce the same outcome for the random variable, their probabilities must be combined by addition, since either path counts.' },
        { q: 'A student takes an exam with up to 2 attempts: 40% chance of passing on attempt 1; if needed, 60% chance of passing on attempt 2. Let A = number of attempts needed to pass OR run out of attempts. What is P(A = 1)?', opts: ['0.40', '0.60', '0.24', '1.0'], correct: 0, exp: 'Passing right away on the first attempt: P = 0.40.' },
        { q: 'Using the same exam scenario, what is P(A = 2)?', opts: ['0.24', '0.36', '1.0', '0.60'], correct: 3, exp: 'Since there’s no third attempt, A = 2 simply means "failed attempt 1" — it doesn’t matter whether attempt 2 itself succeeds, because either way the student needed exactly 2 attempts. P(A = 2) = 1 − P(A = 1) = 1 − 0.40 = 0.60. (The 60% pass rate on attempt 2 would matter for a different question, like "did the student ultimately pass," but not for counting attempts here.)' },
        { q: 'A student takes a quiz with up to 3 attempts: 40% correct on attempt 1; if needed, 60% correct on attempt 2; if needed, 80% correct on attempt 3. Let A = number of attempts needed (max 3). What is P(A = 1)?', opts: ['0.36', '0.60', '0.40', '0.24'], correct: 2, exp: 'Correct right away: P = 0.40.' },
        { q: 'Using the same quiz scenario, what is P(A = 2)?', opts: ['0.36', '0.60', '0.24', '0.40'], correct: 0, exp: 'Wrong on attempt 1, then correct on attempt 2: 0.60 × 0.60 = 0.36.' },
        ...
        { q: 'A discrete distribution shows P(0)=0.18, P(1)=0.225, P(2)=0.595 for a horse’s wins in two races. What is P(at least 1 win)?', opts: ['0.595', '0.225', '0.82', '0.18'], correct: 2, exp: 'P(at least 1 win) = P(1) + P(2) = 0.225 + 0.595 = 0.82, or equivalently 1 − P(0) = 1 − 0.18 = 0.82.' },
        { q: 'A carnival game distribution shows P(1)=0.65, P(2)=0.2275, P(3)=0.079625, P(4)=0.042875 for number of throws needed. What is P(more than 2 throws)?', opts: ['0.79625', '0.1225', '0.2275', '0.65'], correct: 1, exp: 'P(N > 2) = P(3) + P(4) = 0.079625 + 0.042875 = 0.1225.' },
        ...
        { q: 'Sasha scores 10/9/8 with probabilities 0.2/0.5/0.3. Penny scores 11/10/9 with probabilities 0.1/0.55/0.35. What is P(Sasha − Penny = 1)?', opts: ['0.07', '0.20', '0.55', '0.02'], correct: 0, exp: 'Only one pair gives a difference of 1: Sasha=10, Penny=9. P = 0.2 × 0.35 = 0.07.' },
        { q: 'Which of the following would make a probability distribution table INVALID?', opts: ['All probabilities are between 0 and 1', 'The probabilities sum to 1', 'The random variable has exactly 4 possible outcomes', 'One of the listed probabilities is negative'], correct: 3, exp: 'Every individual probability must be between 0 and 1 inclusive — a negative probability is never valid, no matter what the rest of the table looks like.' },
        { q: 'A game show distribution has outcomes $0, $100, $500, $1000 with probabilities 0.5, 0.3, 0.15, and 0.05. Verify this is a valid distribution and find P(wins at least $500).', opts: ['Sums to 1.0; P(at least $500) = 0.15', 'Sums to 1.0; P(at least $500) = 0.20', 'Sums to 0.9; invalid distribution', 'Sums to 1.1; invalid distribution'], correct: 1, exp: '0.5+0.3+0.15+0.05 = 1.0, so it’s valid. P(at least $500) = P($500) + P($1000) = 0.15 + 0.05 = 0.20.' }
      ]
    }
  }
});
  ...
  '2-9': {
    ...
    sections: [
      ...
      /* ---------------- 7. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'The mean of a random variable is also known as its:', opts: ['Standard deviation', 'Complement', 'Expected value', 'Parameter range'], correct: 2, exp: 'Mean and expected value are interchangeable terms — both refer to μ_X or E(X).' },
          ...
          { q: 'Why is there no formula for the mean of a continuous random variable?', opts: ['Continuous random variables never have a mean', 'The mean of a continuous variable is always 0', 'Continuous random variables are always symmetric', 'The outcomes can’t be listed, so you can’t multiply each one by its probability and sum'], correct: 3, exp: 'The discrete formula requires listing every outcome — impossible for a continuous variable with infinitely many possible values on an interval.' },
          { q: 'If Y = 4X (a pure multiplication, no added constant), and μ_X = 10, what is μ_Y?', opts: ['10', '4', '40', '14'], correct: 2, exp: 'μ_Y = 4 × μ_X = 4 × 10 = 40.' },
          { q: 'Using the same transformation Y = 4X, if σ_X = 3, what is σ_Y?', opts: ['7', '12', '3', '4'], correct: 1, exp: 'σ_Y = |4| × σ_X = 4 × 3 = 12 — multiplication scales the standard deviation too.' },
          { q: 'If Y = X + 10 (pure addition, no multiplication), and σ_X = 5, what is σ_Y?', opts: ['5', '50', '10', '15'], correct: 0, exp: 'Adding a constant shifts every value equally but does not change the spread: σ_Y = σ_X = 5.' },
    ...
    homework: {
      estTime: '~35 min',
      questions: [
        { q: 'A parameter is best defined as:', opts: ['A numerical value measuring a characteristic of a population or probability distribution', 'Always the mean of a data set', 'A number describing a sample', 'A value that only applies to continuous random variables'], correct: 0, exp: 'A parameter describes a population or distribution — a single fixed value, unlike a statistic (which comes from a sample).' },
        { q: 'The mean of a random variable is also called its:', opts: ['Interquartile range', 'Expected value', 'Range', 'Standard score'], correct: 1, exp: 'Mean and expected value (E(X)) are the same thing for a random variable.' },
        { q: 'A random variable X has P(1)=0.3, P(2)=0.5, P(3)=0.2. What is μ_X?', opts: ['2.0', '2.1', '1.9', '1.7'], correct: 2, exp: 'μ_X = 1(0.3) + 2(0.5) + 3(0.2) = 0.3 + 1.0 + 0.6 = 1.9.' },
        { q: 'A random variable X has values 0, 1, 2 with probabilities 0.2, 0.5, 0.3. What is μ_X?', opts: ['1.0', '1.1', '1.2', '0.9'], correct: 1, exp: 'μ_X = 0(0.2) + 1(0.5) + 2(0.3) = 0 + 0.5 + 0.6 = 1.1.' },
        { q: 'Using the same distribution (values 0/1/2, probabilities 0.2/0.5/0.3, μ = 1.1), what is σ_X?', opts: ['0.49', '0.7', '0.3', '1.1'], correct: 1, exp: 'σ_X = √[(0−1.1)²(.2) + (1−1.1)²(.5) + (2−1.1)²(.3)] = √[0.242+0.005+0.243] = √0.49 = 0.7.' },
        ...
        { q: 'A shipping company’s package weight has μ = 12 lb, σ = 3 lb. If Y = 2X (weight doubled, no constant added), what is μ_Y?', opts: ['24', '14', '12', '6'], correct: 0, exp: 'μ_Y = 2 × 12 = 24.' },
        { q: 'Using the same transformation Y = 2X, what is σ_Y?', opts: ['9', '3', '6', '1.5'], correct: 2, exp: 'σ_Y = |2| × 3 = 6 — multiplication scales the standard deviation.' },
        { q: 'A random variable has μ = 40, σ = 6. If Y = X − 15 (pure subtraction, no multiplication), what is μ_Y?', opts: ['25', '6', '55', '40'], correct: 0, exp: 'μ_Y = 40 − 15 = 25 — subtraction shifts the mean.' },
        ...
        { q: 'Using the same dealership scenario, what is the standard deviation of weekly net profit?', opts: ['$2,000', '$1,500', '$3,500', '$4,000'], correct: 3, exp: 'σ = 2000 × 2 = $4,000. The $500 overhead is a constant subtraction and does not affect the standard deviation.' },
        { q: 'A distance measured in miles has μ = 26.2, σ = 3.1. Convert both to kilometers (1 mile = 1.609 km).', opts: ['μ ≈ 42.16 km, σ ≈ 3.1 km', 'μ ≈ 16.29 km, σ ≈ 1.93 km', 'μ ≈ 42.16 km, σ ≈ 4.99 km', 'μ ≈ 27.81 km, σ ≈ 3.1 km'], correct: 2, exp: 'This is pure multiplication by the conversion factor: μ = 26.2 × 1.609 ≈ 42.16 km, σ = 3.1 × 1.609 ≈ 4.99 km — both scale by the same factor.' },
        { q: 'A temperature random variable has μ = 20°C, σ = 4°C. Convert to Fahrenheit using °F = 1.8×°C + 32. What is μ in °F?', opts: ['20', '68', '52', '36'], correct: 1, exp: 'μ_F = 1.8 × 20 + 32 = 36 + 32 = 68°F.' },
        ...
        { q: 'A raffle ticket costs $10, and a random variable X represents the number of winning tickets (out of many) a buyer holds, with μ_X = 0.3, σ_X = 0.5. Each winning ticket pays $200. What is the mean payout?', opts: ['$30', '$200', '$60', '$2,000'], correct: 2, exp: 'μ_payout = 200 × 0.3 = $60.' },
        { q: 'Using the same raffle scenario, what is the standard deviation of the payout?', opts: ['$0.5', '$50', '$100', '$200'], correct: 2, exp: 'σ_payout = 200 × 0.5 = $100.' },
        { q: 'A distribution has outcomes −2, 0, 3 with probabilities 0.25, 0.5, 0.25. What is μ_X?', opts: ['1.0', '0.75', '0.5', '0.25'], correct: 3, exp: 'μ_X = (−2)(0.25) + 0(0.5) + 3(0.25) = −0.5 + 0 + 0.75 = 0.25.' },
        { q: 'A weather station reports that daily high temperatures have μ = 75°F with σ = 6°F — no formula was used to find these. Why not?', opts: ['Temperature is a discrete random variable', 'Temperature is continuous — you can’t list every possible decimal value, so these had to come from real measurement over many days', 'The weather station made an error', 'σ is never calculable for temperature'], correct: 1, exp: 'Temperature can take any value on a continuous interval (including many decimal places), so μ and σ must be measured directly rather than computed from a discrete formula.' },
        { q: 'Which transformation would change BOTH the mean and standard deviation of a random variable?', opts: ['Y = X + 5', 'Y = X (no change at all)', 'Y = X − 12', 'Y = 3X'], correct: 3, exp: 'Multiplying by a constant (Y = 3X) changes both the mean (scales by 3) and the standard deviation (scales by 3). Pure addition or subtraction only changes the mean.' }
      ]
    }
  }
});
  ...
  '2-10': {
    ...
    sections: [
      ...
      /* ---------------- 7. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'Which of these is NOT one of the B.I.T.S. conditions for a binomial random variable?', opts: ['Trials are normally distributed', 'Binary outcomes', 'Same probability of success every trial', 'Independent trials'], correct: 0, exp: 'B.I.T.S. stands for Binary, Independent, Trials (fixed number), and Same probability — normality is never a requirement.' },
          { q: 'A basketball player shoots free throws where each make increases the probability of the next make. This scenario fails which B.I.T.S. condition?', opts: ['Binary', 'Trials fixed', 'Independent (and same probability)', 'None — it’s still binomial'], correct: 2, exp: 'Since the probability changes based on previous outcomes, both independence and "same probability" are violated.' },
          { q: 'The 10% condition allows you to treat sampling WITHOUT replacement as approximately binomial when:', opts: ['The sample is more than 50% of the population', 'The sample is less than 10% of the population', 'The population is smaller than the sample', 'p is exactly 0.10'], correct: 1, exp: 'If the sample size is under 10% of the population, removing individuals barely changes the probability — close enough to independent.' },
          { q: 'The binomial probability formula P(X=x) = ₙCₓ·pˣ·(1−p)ⁿ⁻ˣ — what does the ₙCₓ part represent?', opts: ['The probability of the failures', 'The number of different ways to arrange x successes among n trials', 'The probability of x successes', 'The mean of the distribution'], correct: 1, exp: 'Combinations count how many different orderings produce exactly x successes — every one of those orderings has the same probability, so you multiply by how many there are.' },
          { q: 'A binomial random variable has n=6, p=0.5. What is ₆C₂ (the number of ways to get exactly 2 successes)?', opts: ['12', '30', '15', '6'], correct: 2, exp: '₆C₂ = 15.' },
          { q: 'For a binomial random variable with n=10, p=0.3, what is the mean?', opts: ['10', '0.3', '7', '3'], correct: 3, exp: 'μ = np = 10 × 0.3 = 3.' },
          { q: 'For the same distribution (n=10, p=0.3), what is the standard deviation?', opts: ['1.449', '0.21', '3', '2.1'], correct: 0, exp: 'σ = √[np(1−p)] = √(10×0.3×0.7) = √2.1 ≈ 1.449.' },
          { q: '"At least 3 successes" means:', opts: ['More than 3, not including 3', '3 or fewer', 'Exactly 3', '3 or more'], correct: 3, exp: '"At least" always means that value or greater — ≥.' }
        ]
      },
    ...
    homework: {
      estTime: '~35 min',
      questions: [
        { q: 'A binomial random variable requires all of the following EXCEPT:', opts: ['A fixed number of trials', 'Independent trials', 'A large sample size (n > 30)', 'The same probability of success on every trial'], correct: 2, exp: 'There is no minimum sample size requirement for a binomial random variable — B.I.T.S. never mentions sample size.' },
        ...
        { q: 'A jar has 8 marbles, 3 red. 4 are drawn without replacement. Is the number of red marbles drawn binomial?', opts: ['Yes, since red/not-red is binary', 'Cannot be determined without knowing the exact probability', 'Yes, by the 10% condition', 'No — removing marbles from such a small jar changes the probability too much to be treated as independent'], correct: 3, exp: 'With only 8 marbles total, drawing 4 without replacement is a huge fraction of the population — the 10% condition does NOT apply here.' },
        ...
        { q: 'For a binomial random variable with n=7, p=0.4, what is ₇C₃ (ways to get exactly 3 successes)?', opts: ['7', '21', '35', '28'], correct: 2, exp: '₇C₃ = 35.' },
        { q: 'Using the binomial formula, find P(X=3) for n=5, p=0.6.', opts: ['0.0778', '0.2304', '0.6000', '0.3456'], correct: 3, exp: 'P(3) = ₅C₃(0.6)³(0.4)² = 10 × 0.216 × 0.16 = 0.3456.' },
        { q: 'For n=5, p=0.6, what is the mean of the distribution?', opts: ['2', '3', '0.6', '5'], correct: 1, exp: 'μ = np = 5 × 0.6 = 3.' },
        { q: 'For the same distribution (n=5, p=0.6), what is the standard deviation?', opts: ['1.095', '0.49', '3', '1.2'], correct: 0, exp: 'σ = √[np(1−p)] = √(5×0.6×0.4) = √1.2 ≈ 1.095.' },
        { q: 'A binomial random variable has n=10, p=0.4. What is P(X=0)?', opts: ['0.006047', '0.04', '0.0001', '0.4'], correct: 0, exp: 'P(0) = ₁₀C₀(0.4)⁰(0.6)¹⁰ = 0.6¹⁰ ≈ 0.006047.' },
        { q: 'Using the same distribution (n=10, p=0.4), what is P(at least 1)?', opts: ['0.006047', '0.4', '0.993953', '0.6'], correct: 2, exp: 'P(at least 1) = 1 − P(0) = 1 − 0.006047 ≈ 0.993953.' },
        { q: 'A binomial random variable has n=6, p=0.5. What is P(at most 2)?', opts: ['0.6875', '0.3438', '0.5', '0.1563'], correct: 1, exp: 'P(at most 2) = P(0)+P(1)+P(2) = 0.0156+0.0938+0.2344 ≈ 0.3438.' },
        { q: 'A binomial random variable has n=15, p=0.3. What is P(exactly 4)?', opts: ['0.3', '0.2186', '0.15', '0.4'], correct: 1, exp: 'P(4) = ₁₅C₄(0.3)⁴(0.7)¹¹ ≈ 0.2186.' },
        { q: 'A binomial random variable has n=12, p=0.25. What is the mean?', opts: ['3', '12', '9', '0.25'], correct: 0, exp: 'μ = np = 12 × 0.25 = 3.' },
        { q: 'Using the same distribution (n=12, p=0.25), what is the standard deviation?', opts: ['2.25', '1.5', '3', '0.19'], correct: 1, exp: 'σ = √[np(1−p)] = √(12×0.25×0.75) = √2.25 = 1.5.' },
        { q: 'A survey finds 60% of students prefer online homework. In a random sample of 8 students, what is P(exactly 5 prefer online homework)?', opts: ['0.279', '0.124', '0.6', '0.5'], correct: 0, exp: 'P(5) = ₈C₅(0.6)⁵(0.4)³ = 56 × 0.07776 × 0.064 ≈ 0.279.' },
        { q: 'A basketball player makes 70% of free throws and shoots 6. What is P(makes all 6)?', opts: ['0.7', '0.0007', '0.1176', '0.42'], correct: 2, exp: 'P(6) = ₆C₆(0.7)⁶(0.3)⁰ = 0.7⁶ ≈ 0.1176.' },
        { q: 'Which phrase corresponds to P(X ≤ 5)?', opts: ['At least 5', 'Exactly 5', 'More than 5', 'At most 5'], correct: 3, exp: '"At most 5" means 5 or fewer, which is P(X ≤ 5).' },
        { q: 'Which phrase corresponds to P(X ≥ 2)?', opts: ['Fewer than 2', 'At least 2', 'Exactly 2', 'At most 2'], correct: 1, exp: '"At least 2" means 2 or more, which is P(X ≥ 2).' },
...
registerChapters({
  '2-11': {
    ...
    sections: [
      ...
      /* ---------------- 7. QUIZ ---------------- */
      {
        ...
        questions: [
          ...
          { q: 'A normal distribution is fully described by:', opts: ['Its mean and standard deviation', 'Its minimum and maximum', 'Its median and range', 'Its five-number summary'], correct: 0, exp: 'Just two parameters — mean (center) and standard deviation (spread) — define the entire curve.' },
          { q: 'By the empirical rule, approximately what percent of data falls within 2 standard deviations of the mean?', opts: ['68%', '95%', '99.7%', '50%'], correct: 1, exp: 'The 68-95-99.7 rule: 95% falls within 2 SD.' },
          ...
          { q: 'To find what value marks the 25th percentile of a normal distribution, you would use:', opts: ['The empirical rule only', 'The general multiplication rule', 'The binomial formula', 'Inverse normal'], correct: 3, exp: 'Working backward from a percentage to a value requires inverse normal.' },
          ...
          { q: 'A distribution has mean 500, SD 100. What is P(X > 700)?', opts: ['Cannot be determined', 'z=2, P(Z>2)≈0.9772', 'z=2, P(Z>2)≈0.0228', 'z=7, P(Z>7)≈0'], correct: 2, exp: 'z = (700−500)/100 = 2. The area to the right of z=2 is about 2.28%.' },
    ...
    homework: {
      estTime: '~40 min',
      questions: [
        { q: 'A continuous random variable differs from a discrete one because:', opts: ['It can only take on whole number values', 'Its outcomes fall on an interval and can’t all be listed — probability only applies to intervals, not exact values', 'It never has a mean or standard deviation', 'Its outcomes can be listed'], correct: 1, exp: 'Continuous random variables have infinitely many possible values on an interval, so only interval probabilities make sense.' },
        { q: 'A normal distribution is described as:', opts: ['Skewed and bimodal', 'Continuous, unimodal, bell-shaped, and symmetric', 'Discrete and uniform', 'Always centered at zero'], correct: 1, exp: 'These four properties define the shape of a normal distribution.' },
        { q: 'Adult heights are approximately N(66, 3) — mean 66 inches, SD 3 inches. What is the z-score for a height of 72 inches?', opts: ['2', '6', '0.5', '18'], correct: 0, exp: 'z = (72−66)/3 = 6/3 = 2.' },
        { q: 'IQ scores are N(100, 15). What is P(IQ > 130)?', opts: ['z=2, P≈0.0228', 'z=2, P≈0.9772', 'z=30, P≈0', 'z=−2, P≈0.9772'], correct: 0, exp: 'z = (130−100)/15 = 2. P(Z>2) ≈ 0.0228, or 2.28%.' },
        { q: 'SAT section scores are N(500, 100). What is P(score < 650)?', opts: ['z=6.5, P≈1', 'z=1.5, P≈0.0668', 'z=1.5, P≈0.9332', 'z=−1.5, P≈0.9332'], correct: 2, exp: 'z = (650−500)/100 = 1.5. P(Z<1.5) ≈ 0.9332, or 93.3%.' },
        { q: 'Using the empirical rule, adult heights N(66,3): approximately what percent of adults are between 63 and 69 inches?', opts: ['95%', '50%', '68%', '99.7%'], correct: 2, exp: '63 and 69 are exactly mean ± 1 SD, which the empirical rule says contains about 68% of data.' },
        ...
        { q: 'A normal distribution has mean 50, SD 8. What value marks the 95th percentile?', opts: ['z≈1.282, x≈60.26', 'z≈1.96, x≈65.68', 'z=2, x=66', 'z≈1.645, x≈63.16'], correct: 3, exp: 'The z-score with 95% below it is about 1.645. x = 50 + 1.645(8) ≈ 63.16.' },
        ...
        { q: 'A normal distribution has mean 200, unknown SD. 10% of values are above 230. Find σ.', opts: ['z≈1.645, σ≈18.24', 'z≈1.282, σ≈23.41', 'z≈0.10, σ≈300', 'z≈1.96, σ≈15.31'], correct: 1, exp: '10% above 230 means 90% below it: z ≈ 1.282. Solving 1.282 = (230−200)/σ gives σ ≈ 23.41.' },
        { q: 'A manufacturing process produces bolts with length N(μ, 0.2 cm). 5% of bolts are longer than 10.4 cm. Find μ.', opts: ['z≈−1.645, μ≈10.73', 'z≈1.96, μ≈10.01', 'z≈1.282, μ≈10.14', 'z≈1.645, μ≈10.07'], correct: 3, exp: '5% above 10.4 means 95% below it: z ≈ 1.645. Solving 1.645 = (10.4−μ)/0.2 gives μ ≈ 10.07.' },
        ...
        { q: 'A distribution has both μ and σ unknown. The 40th percentile is 55, and the 70th percentile is 68. Which approach is correct?', opts: ['Assume σ=1 and solve for μ only', 'It cannot be solved without a third percentile', 'Use the empirical rule directly since two points are given', 'Set up z=(55−μ)/σ and z=(68−μ)/σ using the two corresponding z-scores, then solve the system'], correct: 3, exp: 'With two unknowns, you need the two equations formed from the two given percentiles, solved as a system.' },
        { q: 'Continuing the same scenario (40th percentile = 55, 70th percentile = 68): the z-scores are approximately −0.253 and 0.524. What is the approximate standard deviation?', opts: ['≈25.09', '≈8.36', '≈16.71', '≈13.0'], correct: 2, exp: 'From z=(x−μ)/σ: 55 = μ − 0.253σ and 68 = μ + 0.524σ. Subtracting the first from the second eliminates μ: 68 − 55 = 0.524σ − (−0.253σ) → 13 = 0.777σ → σ ≈ 16.71.' },
        { q: 'A normal distribution has mean 45, SD 6. What is P(39 < X < 57)?', opts: ['z=−2 to z=1, P≈0.8186', 'z=1 to z=2, P≈0.1359', 'z=−1 to z=2, P≈0.8186', 'z=−1 to z=1, P≈0.6827'], correct: 2, exp: 'z for 39 = (39−45)/6 = −1. z for 57 = (57−45)/6 = 2. P(−1<Z<2) ≈ 0.8186.' },
        { q: 'A quality control process rejects any part more than 2.5 SD from the mean. Approximately what percent of parts are rejected?', opts: ['About 1.24%', 'About 5%', 'About 0.3%', 'About 32%'], correct: 0, exp: 'P(|Z|>2.5) = 2 × P(Z>2.5) ≈ 2 × 0.0062 ≈ 0.0124, or about 1.24%.' },
        { q: 'Why can’t you calculate P(X = exactly 100) for a continuous random variable X?', opts: ['Because a single exact value has zero width, so it corresponds to zero area under the density curve', 'Because 100 is too large a number', 'Because continuous random variables don’t have means', 'Because probabilities can only be calculated for discrete variables'], correct: 0, exp: 'Probability for a continuous random variable is area under the curve — a single point has no width, so its "area" (and probability) is exactly 0.' },
        { q: 'A normal distribution has mean 60. A value of 60 corresponds to which percentile?', opts: ['0th', '50th', '100th', 'Cannot be determined without the SD'], correct: 1, exp: 'By symmetry, the mean is always exactly the median — the 50th percentile — for any normal distribution, regardless of the standard deviation.' },
        ...
        { q: 'A problem states a value is at the "1st percentile" of a normal distribution. What does this mean?', opts: ['1% of values are above it', '1% of values are below it, 99% are above it', '99% of values are below it', 'The value equals the mean minus 1'], correct: 1, exp: 'The 1st percentile has exactly 1% of the distribution below it (and 99% above) — an extremely low value.' }
      ]
    }
  }
});
  ...
  '2-12': {
    ...
    sections: [
      ...
      /* ---------------- 7. QUIZ ---------------- */
      {
        ...
        heading: 'Test yourself. <span class="underline">No pressure.</span>',
        questions: [
          { q: 'A sampling distribution shows:', opts: ['The distribution of a statistic across all possible samples of a given size', 'The value of one specific sample', 'The entire population, one individual at a time', 'Only the mean and standard deviation of the population'], correct: 0, exp: 'A sampling distribution captures every possible value the statistic could take across all possible samples of that size.' },
          { q: 'Before a random sample is drawn, its sample proportion p̂ is best described as:', opts: ['A fixed parameter', 'Always equal to the population proportion', 'A random variable — its value is unknown until the sample is drawn', 'A number that never changes between samples'], correct: 2, exp: 'p̂ is a random variable because its exact value depends on which individuals happen to end up in the sample.' },
          { q: 'Why can a sampling distribution typically only be approximated through simulation rather than built exactly by hand?', opts: ['Because computers cannot do statistics', 'Because simulation is required by the AP exam rules', 'Because sampling distributions do not really exist', 'Because the number of all possible samples of a given size from a real population is far too large to draw them all'], correct: 3, exp: 'Actually drawing literally every possible sample is generally not feasible, so a large number of simulated samples is used to approximate the true sampling distribution.' },
          { q: 'A population proportion is p = 0.45. Which sample proportion from a large sample would be the LEAST surprising?', opts: ['p̂ = 0.90', 'p̂ = 0.44', 'p̂ = 0.05', 'p̂ = 0.99'], correct: 1, exp: 'Sample proportions close to the true population proportion (0.45) are the most common outcomes — 0.44 is barely different from 0.45.' },
          { q: 'A sampling distribution of sample means is built from a population that is heavily skewed right. What shape would you expect the sampling distribution itself to have?', opts: ['Also heavily skewed right, matching the population', 'Approximately normal, even though the population is skewed', 'Uniform, since skewness cancels out', 'Impossible to determine without more information'], correct: 1, exp: 'One of the most important facts about sampling distributions: they tend toward an approximately normal shape, even when the underlying population is skewed.' },
          { q: 'On a simulated sampling distribution of sample means, what does each individual dot represent?', opts: ['One individual measurement from the population', 'The standard deviation of one sample', 'The true population mean', 'The mean of one entire sample'], correct: 3, exp: 'Each dot summarizes one whole sample — its sample mean — not a single individual’s value.' },
          { q: 'A sampling distribution of a statistic will be centered at:', opts: ['The true population parameter', 'The sample size, n', 'Zero, always', 'Whatever the first sample happened to produce'], correct: 0, exp: 'Sampling distributions are centered at the true population parameter — the value the statistic is estimating.' },
          { q: 'A researcher draws only 5 samples and looks at the resulting 5 dots. Is this the sampling distribution?', opts: ['Yes, any number of samples gives the exact sampling distribution', 'Yes, but only if the population is normal', 'No — 5 samples is far too few to represent all possible samples; it only begins to approximate the true sampling distribution', 'No — sampling distributions cannot be simulated at all'], correct: 2, exp: 'The true sampling distribution includes every possible sample. Just 5 simulated samples is nowhere near enough to reveal its full shape — many more are needed for a good approximation.' }
        ]
      },
    ...
    homework: {
      estTime: '~30 min',
      questions: [
        { q: 'A sampling distribution is the distribution of:', opts: ['One individual’s data value', 'Only the largest possible sample', 'The entire population', 'A statistic across all possible samples of a given size'], correct: 3, exp: 'It captures every possible value a statistic could take across all samples of that size.' },
        { q: 'The true proportion of adults who exercise daily is p = 0.35. This value is called a:', opts: ['Population parameter', 'Sample proportion', 'Statistic', 'Sampling distribution'], correct: 0, exp: 'A single fixed value describing the entire population is a parameter, not a statistic.' },
        { q: 'A researcher samples 200 adults and finds 78 exercise daily. This value (78/200 = 0.39) is called a:', opts: ['Population parameter', 'A random process', 'A sampling distribution', 'Sample statistic (specifically, a sample proportion)'], correct: 3, exp: 'A number computed from a sample — like this sample proportion — is a statistic.' },
        { q: 'Before a specific sample of 200 adults is actually collected, its resulting sample proportion is best described as:', opts: ['A random variable, since its value is not yet known', 'A known, fixed number', 'Always exactly equal to 0.35', 'Not a meaningful quantity'], correct: 0, exp: 'Until the sample is actually drawn, the resulting statistic is unknown — a random variable.' },
        { q: 'Why is it typically impossible to construct a sampling distribution by listing literally every possible sample?', opts: ['Because populations never have a fixed size', 'Because the number of possible samples of a given size is generally far too large to enumerate', 'Because sample statistics are always identical', 'Because computers cannot generate random numbers'], correct: 1, exp: 'For most real populations, the number of distinct possible samples of a given size is enormous — simulation approximates the result instead.' },
        { q: 'A sampling distribution is simulated by:', opts: ['Repeatedly drawing random samples of the same size, recording each one’s statistic, and observing the resulting pattern', 'Surveying the entire population exactly once', 'Calculating the population parameter directly with a formula', 'Randomly guessing the shape of the distribution'], correct: 0, exp: 'Each simulated sample contributes one data point (its statistic) to the growing picture of the sampling distribution.' },
        { q: 'A sampling distribution of sample means, built from many samples of size 60, will be centered at approximately:', opts: ['Zero', 'The true population mean', 'The sample size, 60', 'The largest sample mean observed'], correct: 1, exp: 'Sampling distributions are centered at the true population parameter they are estimating.' },
        ...
        { q: 'On a simulated sampling distribution of sample proportions, one specific dot sits far to the right, near 0.95, while the true population proportion is 0.40. What does this suggest?', opts: ['The true population proportion must actually be 0.95', 'This particular sample happened to be an unusual, low-probability outcome, but it is still possible', 'The simulation is broken', 'All samples must produce exactly 0.40'], correct: 1, exp: 'Values far from the true parameter are possible in any individual sample — just increasingly unlikely the farther they are from the truth.' },
        { q: 'A teacher draws 500 simulated samples of size 40 from a population with known mean 72. Roughly where would you expect most of the 500 sample-mean dots to cluster?', opts: ['Spread perfectly evenly from the lowest to highest possible value', 'Clustered closely around 72, thinning out on both sides', 'Clustered near 0', 'Clustered near 40, the sample size'], correct: 1, exp: 'Sample means cluster around the true population mean, with fewer and fewer samples landing farther from it.' },
        { q: 'Which of these correctly distinguishes a "statistic" from a "parameter"?', opts: ['They are exactly the same thing', 'A statistic describes a population; a parameter describes a sample', 'A statistic describes a sample; a parameter describes a population', 'A parameter can change, but a statistic never does'], correct: 2, exp: 'Statistic = from a sample (varies sample to sample). Parameter = the one true, fixed value for the population.' },
        { q: 'A single simulated sample of size 30 produces a sample mean of x̄ = 118, while the true population mean is μ = 120. What does this small difference suggest?', opts: ['The population mean must actually be 118', 'This proves the population is not normally distributed', 'The sample must have been collected incorrectly', 'This is a completely normal, unsurprising result — sample means vary somewhat from the true mean by chance'], correct: 3, exp: 'Sample means naturally vary from sample to sample — landing close to (but not exactly on) the true mean is exactly what’s expected.' },
        { q: 'Why does simulating 1,000 samples give a better approximation of a sampling distribution than simulating just 10 samples?', opts: ['It doesn’t — 10 samples is always just as good', '1,000 samples guarantees a perfectly uniform distribution', 'Simulating more samples changes the true population parameter', 'More simulated samples more closely approximate the full range and pattern of all possible samples, revealing the true center and shape more clearly'], correct: 3, exp: 'The true sampling distribution includes every possible sample; more simulated samples get closer to representing that complete picture.' },
        { q: 'A claim states that 55% of voters support a proposal. In a simulated sampling distribution of sample proportions from many samples of size 300, which outcome would be most common?', opts: ['Sample proportions very close to 55%', 'Sample proportions very close to 0% or 100%', 'Sample proportions uniformly spread across every possible value', 'Sample proportions exactly equal to 55% every single time'], correct: 0, exp: 'Most samples should land close to the true population proportion; extreme values become increasingly rare.' },
        { q: 'What is the key difference between "the sampling distribution" and "a simulation of 300 samples used to approximate it"?', opts: ['There is no difference — they are always identical', 'The simulation is always more accurate than the true sampling distribution', 'The true sampling distribution includes every possible sample; the simulation is only an approximation built from a limited number of them', 'A simulation cannot approximate a sampling distribution at all'], correct: 2, exp: 'A simulation is a practical stand-in that approximates the true (and often impossible to fully construct) sampling distribution.' },
        ...
        { q: 'What does it mean to say a sample statistic is an unbiased indicator of the population parameter, based on what this topic demonstrated?', opts: ['Every single sample will produce exactly the parameter value', 'The statistic and the parameter are always numerically identical', 'The sampling distribution is centered at the true parameter, so on average, samples tend to estimate it correctly even though any one sample may be off', 'Bias has nothing to do with sampling distributions'], correct: 2, exp: 'While no single sample is guaranteed to match the parameter exactly, the sampling distribution being centered at the true value means samples tend to estimate it correctly "on average."' },
        { q: 'A quality control team wants to estimate the true defect rate in a factory. Why would examining the sampling distribution of sample proportions (from repeated samples) be more informative than looking at just one sample?', opts: ['It would not be more informative — one sample is always sufficient', 'It changes the true defect rate', 'It reveals how much sample proportions naturally vary from sample to sample, showing how much a single sample result could be trusted', 'Sampling distributions only apply to sample means, never proportions'], correct: 2, exp: 'Seeing the spread and pattern of many possible sample results shows how reliable — or how variable — any single sample’s result is likely to be.' },
        { q: 'A histogram of 1,000 simulated sample means is unimodal, roughly symmetric, and centered near the known population mean. What does this confirm about the sampling distribution?', opts: ['That the population must also be exactly this shape', 'That it behaves as expected for a sampling distribution — centered at the true parameter with an approximately normal shape', 'That an error occurred in the simulation', 'That the sample size must have been too small'], correct: 1, exp: 'This is precisely the expected behavior of a sampling distribution: centered at the population parameter, with an approximately normal shape.' }
      ]
    }
  }
});
